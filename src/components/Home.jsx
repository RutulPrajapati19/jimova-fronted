    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .jm-manifesto-num {
          ...
          -webkit-text-stroke: 1px #232323; line-height: 1; z-index: 0;
          user-select: none; pointer-events: none;
        }
        .jm-manifesto-corner {
          position: absolute; width: 22px; height: 22px;
          border: 1px solid #C5A059; opacity: 0.6; z-index: 2;
        }
        ...
        .jm-manifesto-cta {
          position: relative; z-index: 1; margin-top: 34px; width: 100%;
          background: transparent; border: 1px solid #2E2E2E; color: #FFFFFF;
          padding: 15px 20px; font-size: 10px; font-weight: 700; letter-spacing: 2px;
      ...
      <div style={{ background: "#FCFCFC", minHeight: "100vh", fontFamily: "'Inter', sans-serif" }}>
        ...
        <div style={{ padding: "0 6%", background: "#FCFCFC", borderBottom: "1px solid #EBEBEB", position: "relative", overflow: "hidden" }}>
          ...
          <div className="jm-hero-grid" style={{ display: "grid", gridTemplateColumns: "1.15fr 0.85fr", gap: "64px", padding: "80px 0 80px 48px", alignItems: "center", position: "relative", zIndex: 1 }}>
            <div className={`jm-hero-in ${heroVisible ? "visible" : ""}`}>
              ...
              <h1 className="jm-serif" style={{ fontSize: "clamp(48px, 5.5vw, 74px)", fontWeight: "400", lineHeight: 1.05, letterSpacing: "-1px", color: "#0D0D0D", margin: "0 0 8px" }}>Premium</h1>
            ...
            <div className={`jm-hero-in delay-1 ${heroVisible ? "visible" : ""}`}>
              <div className="jm-manifesto-panel">
                ...
                <button className="jm-manifesto-cta jm-sans" onClick={() => document.getElementById("jm-curations-anchor")?.scrollIntoView({ behavior: "smooth" })}>
                    ...
                    <div key={`bs-${id}-${i}`} className="jm-card" style={{ width: "260px", flexShrink: 0 }} onClick={() => navigate(`/product/${id}`)}>
                      <div style={{ background: "#F5F5F5", aspectRatio: "4/5", overflow: "hidden", position: "relative", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        ...
                        <div className="jm-price-bar">
                          ...
                          <button className="jm-add-btn jm-sans" onClick={(e) => handleAddToCart(e, p)} disabled={isOut} style={{ padding: "9px 18px", border: isOut ? "1px solid #555" : "1px solid #C5A059", background: "transparent", color: "#C5A059", fontSize: "9px", fontWeight: "700", letterSpacing: "2px", textTransform: "uppercase", cursor: isOut ? "not-allowed" : "pointer" }}>
                            {isOut ? "Sold Out" : "Add"}
                          </button>
                        </div>
                      </div>
        ...
        <div style={{ margin: "60px 6% 0", background: "#111111", padding: "40px 48px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "24px" }}>
          ...
          <div style={{ display: "flex", gap: "48px" }}>
            {[{ icon: "◈", label: "Verified Products" }, { icon: "◉", label: "Secure Checkout" }, { icon: "◎", label: "Free Returns" }].map((f, i) => (
        ...
        {/* PRODUCTS GRID — skeleton or real */}
